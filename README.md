...
http://localhost:3000/liquidity/0x3eA0033F31ca1D9Dfcd9DC113652187C0dd66D9a
...
- It needs [NodeJS](https://nodejs.org) `v16.13.2`
- Create `.env` file and add values for the below:
```env
NEXT_PUBLIC_CHAINID=
NEXT_PUBLIC_API=
