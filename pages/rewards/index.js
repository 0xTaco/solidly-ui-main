      ...
      {account && account.address ?
        ...
        <Paper className={classes.notConnectedContent}>
          ...
          <div className={classes.contentFloat}>
            ...
            Claim rewards for locking tokens, including new token emissions, bribes, and a slice of the transaction fees from your pools. Connect your wallet to continue.
            </Typography>
            <Button
            disableElevation
